...
public class ProviderController implements Serializable {
    ...
    public String signup() {
        try {
            ...
            FacesContext.getCurrentInstance()
                .addMessage(null, new FacesMessage("Signup successful. Please login."));
   ...
   // change password---------------------
    ...
    public String changePassword() {
        ...
        try {
            providerdao.changePassword(
                currentUser.getProviderId(),
                oldPassword,
                newPassword
            );
            FacesContext.getCurrentInstance()
                .addMessage(null, new FacesMessage("Password changed successfully."));
        ...
        try {
            ...
            try {
                ...
                Query q = session.createQuery(
                    "FROM Provider p WHERE p.email = :e"
                );
            ...
            FacesContext.getCurrentInstance()
                .addMessage(null, new FacesMessage("OTP sent to your email."));
    ...
    public String validateForgotPasswordOtp() {
        try {
            boolean ok = providerdao.validateForgotPasswordOtp(
                forgotProviderId, otpCode
            );
            if (!ok) {
                FacesContext.getCurrentInstance()
                    .addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
    ...
    public String completeForgotPassword() {
        ...
        try {
            providerdao.completeForgotPassword(
                forgotProviderId, resetNewPassword
            );
            FacesContext.getCurrentInstance()
                .addMessage(null, new FacesMessage("Password reset successfully. Please login."));
